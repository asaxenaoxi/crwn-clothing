...
import CheckoutPage from './javascript/pages/checkout.page';
...
import { selectCurrentUser } from './javascript/redux/user.redux';
    ...
    return (
      <div>
        ...
        <Switch> 
          ...
          {/*shop is not exact because we will be doing /shop/hats and /shop/sneakers etc, if its exact then 
          you will not be rendering this page on /shop/hats and /shop/sneakers as those do not need to different
          pages but just data changes and the page and structure remains the same*/}
